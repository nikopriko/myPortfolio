...
const add = (saveFirstNumber, saveSecondNumber) => {
  const sum = saveFirstNumber + saveSecondNumber
  return sum
}

// this function takes in two argument/numbers and returns the difference of them
const subtract = (saveFirstNumber, saveSecondNumber) => {
  const difference = saveFirstNumber - saveSecondNumber
  return difference
}
...
const multiply = (saveFirstNumber, saveSecondNumber) => {
  const product = saveFirstNumber *= saveSecondNumber
  return product
...
const divide = (saveFirstNumber, saveSecondNumber) => {
  const quotient = saveFirstNumber / saveSecondNumber
  return quotient
// / to get a quotient,
}

const modulus = (saveFirstNumber, saveSecondNumber) => {
  const remainder = saveFirstNumber % saveSecondNumber
  return remainder
